...
function initModels(sequelize) {
  ...
  products.belongsToMany(users, { as: 'user_id_users', through: carts, foreignKey: "product_id", otherKey: "user_id" });
  users.belongsToMany(products, { as: 'product_id_products', through: carts, foreignKey: "user_id", otherKey: "product_id" });
